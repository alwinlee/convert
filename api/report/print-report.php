<?php
  ...
  // page information
  $curY = date('Y');
  $table_title= $curY." 皈依暨圓根燈會【受皈依】報到通知單";
  ...
  // $info_morning=getPDFinfo($datestring, $monthstring, '上午');
  // $info_afternoon=getPDFinfo($datestring, $monthstring, '下午');
  ...
  while($row = mysql_fetch_array($result,MYSQL_ASSOC))
  {
    ...
    //if (strpos($row["course"], '下午') !== false) {
    //  $pdf->writeHTML($info_afternoon, true, false, false, false, '');
    //} else {
    //  $pdf->writeHTML($info_morning, true, false, false, false, '');
    //}
