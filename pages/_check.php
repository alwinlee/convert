...
<body>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-xs-10" align="center">
                        <h3 class="page-header">皈依法會學員報到報到 報到登錄</h3>
                    </div>
                    <div class="col-xs-1" align="center"></div>
                </div>
                <!-- /.row -->
    ...
    <script src="../resource/js/check.js?{1CFB117E-C3BA-4A04-94C4-F910024D068B}" type="text/javascript" charset="utf-8"></script>
</body>
