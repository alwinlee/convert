...
$currDate=date('Y-m-d');
$apply=$_SESSION["convert_account"];
$debug="NO";
//$debug="YES";
?>
<!DOCTYPE html>
...
<body>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12" align="center">
                        <h4 class="page-header">新增受皈依學員</h4>
    ...
    <script src="../resource/js/newin.js?{1CFB117E-C3BA-4A04-94C4-F910024D068B}" type="text/javascript" charset="utf-8"></script>
</body>
