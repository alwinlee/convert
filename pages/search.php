...
<body>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12" align="center">
                        <h3 class="page-header">皈依法會學員報到報到 學員資料查詢</h3>
                    </div>
                </div>
                <!-- /.row -->
                <div class="row">
    ...
    <script src="../resource/js/search.js?{1CFB117E-C3BA-4A04-94C4-F910024D068B}" type="text/javascript" charset="utf-8"></script>
</body>
