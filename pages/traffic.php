...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-left">
                <li><a class="navbar-brand" href="index.html" > 皈依法會學員報到報到</a></li>
            </ul>
            <!-- -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav nav-first-level" id="side-menu">
                        ...
                        <?php
                            if(isset($_SESSION["convert_auth"])){
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12" align="center">
                        <h3 class="page-header">皈依法會學員報到報到 交通登錄</h3>
                    </div>
                </div>
                <!-- /.row -->
                <div class="row">
    ...
    <script src="../resource/js/fn.js?{1CFB117E-C3BA-4A04-94C4-F910024D068B}"></script>
    <script src="../resource/js/traffic.js?{1CFB117E-C3BA-4A04-94C4-F910024D068B}" type="text/javascript" charset="utf-8"></script>
</body>
