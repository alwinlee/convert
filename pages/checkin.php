...
<body>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12" align="center">
                        <h3 class="page-header">皈依學員報到登錄</h3>
                    </div>
                </div>
                <!-- /.row -->
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8" align="left">
                        ...
                        <input type="checkbox" class="sx-checkbox" id="autocheckin" name="autocheckin">&nbsp;&nbsp;若是輸入報到條碼且剛好找到一位受皈依學員時，就自動報到。
                        </label>
                        </div>
                    </div>
                    <div class="col-lg-2" align="center"></div>
    ...
    <script src="../resource/js/checkin.js?{1CFB117E-C3BA-4A04-94C4-F910024D068B}" type="text/javascript" charset="utf-8"></script>
</body>
